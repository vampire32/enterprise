...
const Services = () => {
  return (
		<div className="u-body u-xl-mode">
			...
			>
				<div className="u-clearfix u-sheet u-sheet-1">
					<h1 className="u-custom-font u-font-source-sans-pro u-text u-text-1">
						We believe in
						<br />
					...
					<h4 className="u-align-center u-text u-text-palette-3-base u-text-3">
						Features
					</h4>
						...
						<div className="u-repeater u-repeater-1">
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-1">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-4">
										{" "}
										01
									</h3>
									<div className="u-container-style u-group u-group-1">
										<div className="u-container-layout u-container-layout-2">
											...
											<p style={{textAlign:"justify"}}  className="u-text u-text-6 text-justify">
											USS Enterprises is providing End-user computing refers to a broad range of user-facing resources, 
										including desktop and notebook computers, desktop operating systems, wearables, mobile devices,
											 and online applications, as well as virtual desktops and applications.{" "}
											</p>
										</div>
									</div>
								</div>
							...
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-3">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-7">
										{" "}
										02
									</h3>
									<div className="u-container-style u-group u-group-2">
										<div className="u-container-layout u-container-layout-4">
											...
											<h4 className="u-text u-text-8">Enterprise Computing</h4>
											<p style={{textAlign:"justify"}}  className="u-text u-text-9">
											USS Enterprises is offering  Enterprise computing  that used by organizations for effective 
											production  is called 
											enterprise computing. Database management, customer relationship management,
											 business process management, and other topics are all covered by these IT technologies.
												{" "}
											</p>
										</div>
									</div>
							...
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-5">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-10">
										03
									</h3>
											...
											<span className="u-icon u-icon-circle u-text-palette-1-base u-icon-3">
												...
												>
													<g>
														...
														<circle cx="431.067" cy="83.944" r="9.992"></circle>
													</g>
												</svg>
											</span>
											<h4 className="u-text u-text-11">Network Solution</h4>
											<p style={{textAlign:"justify"}} className="u-text u-text-12">
											USS Enterprises is offering The objective of publicly traded technology company Network Solutions is to assist
											 business owners in starting, growing, and managing their business online.
											  Hosting, internet marketing, e-commerce, and website security are among the 
							...
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-7">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-13">
										04
									</h3>
									<div className="u-container-style u-group u-group-4">
										<div className="u-container-layout u-container-layout-8">
											...
											<h4 className="u-text u-text-14">Software Solution</h4>
											<p style={{textAlign:"justify"}} className="u-text u-text-15">
											USS Enterprises is offering software solution that typically custom-built or configured to solve a 
											specific customer problem. Software solutions include intrusion detection systems,
											software, and security-auditing software, as well as software firewall packages such as Microsofts 
											Internet Security and Acceleration (ISA) Server, which combine these functions.{" "}
											</p>
										</div>
									</div>
								</div>
							...
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-9">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-16">
										05
									</h3>
									<div className="u-container-style u-group u-group-5">
										<div className="u-container-layout u-container-layout-10">
											...
											<h4 className="u-text u-text-17">Security Solution</h4>
											<p style={{textAlign:"justify"}} className="u-text u-text-18">
											USS Enterprises is offering security solutions having technological tools and services that help protect organizations 
											against cyber attacks. which can result in application downtime, theft of sensitive data
											 and other adverse consequences. These include management security, operational security, and physical security controls.{" "}
											</p>
										</div>
									</div>
								</div>
							...
							<div className="u-container-style u-list-item u-repeater-item">
								<div className="u-container-layout u-similar-container u-container-layout-11">
									<h3 className="u-custom-font u-text u-text-palette-3-light-2 u-text-19">
										06
									</h3>
									<div className="u-container-style u-group u-group-6">
										<div className="u-container-layout u-container-layout-12">
											...
											<h4 className="u-text u-text-20">
												Service &amp; Component Solution
											</h4>
											<p style={{textAlign:"justify"}} className="u-text u-text-21">
											USS Enterprises is offering Service Level Agreements (SLAs), Printings And Scanners Supplies, Printing Solution, 
											Toner And Cartridges, Printing Paper Cartidges, Advertisement And Production Services, Event Managment
			...
			<section className="u-clearfix u-section-33" id="sec-5c97">
				<div className="u-clearfix u-sheet u-sheet-1">
	...
	C6.9,115.6,25.2,125.2,43.2,126.9z"
									...
									<div className="u-container-layout u-container-layout-2">
										<div className="u-align-left u-container-style u-group u-shape-rectangle u-group-1">
											<div className="u-container-layout u-container-layout-3">
												...
												<h2 className="u-text u-text-1">End Using Computing</h2>
												<p className="u-text u-text-2">
													<b>
														...
														<span style={{ fontWeight: 400 }}>hin Client</span>
			...
			<section className="u-clearfix u-section-44" id="carousel_d4ff">
				<div className="u-clearfix u-sheet u-sheet-1">
					<div className="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
						<div className="u-layout">
							<div className="u-layout-row">
											...
											<div className="u-container-layout u-container-layout-3">
												...
												<p className="u-align-justify u-text u-text-2">
													<span style={{ fontSize: "1.25rem" }}>
														{" "}
														We are offering Enterprise Computing include Servers
														| Racks | Storage |NAS | SAN | Hybrid |Backup
														Hardware Solution | Archiving Solution | Coverged
														Infrastructure | Hybrid Covereged Infrastructure.
							...
							<div className="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
								<div className="u-container-layout u-container-layout-1">
									...
									<p className="u-align-justify u-text u-text-2">
										...
										Cartridges | Advertisement &amp; Production Services | Event
										Managment | Archiving Sertvices . So, if you are interested
										in these kind of products just call us we are here for you.
									</p>
								</div>
							</div>
	...
	C6.9,115.6,25.2,125.2,43.2,126.9z"
			...
			<section className="u-clearfix u-section-66" id="carousel_0773">
				<div className="u-clearfix u-sheet u-sheet-1">
							...
							<div className="u-layout-row">
								<div className="u-align-center u-container-style u-layout-cell u-size-30 u-layout-cell-1">
									<div className="u-container-layout u-container-layout-1">
										...
										<p className="u-text u-text-2">
											{" "}
											We are offering Software Solution include Windows License
											| Backup Software Solution | Server Virtualization
											Solution | Network Virtulization Solution | Enterprise
											Cloud Solution. So, if you are interested in these kind of
											products just call us we are here for you.
										</p>
									</div>
								</div>
								<div className="u-container-style u-layout-cell u-size-30 u-layout-cell-2">
	...
	C6.9,115.6,25.2,125.2,43.2,126.9z"
			...
			<section className="u-clearfix u-section-77" id="carousel_b6a8">
				<div className="u-clearfix u-sheet u-sheet-1">
					<div className="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
						<div className="u-layout">
							<div className="u-layout-row">
										...
										<div className="u-container-style u-group u-shape-rectangle u-group-1">
											<div className="u-container-layout u-container-layout-3">
												...
												<p className="u-align-justify u-text u-text-2">
													...
													Mangement Solution | Web Security Solution | End Point
													Securityu Solution | CCTV Surveillance Security
													Solution | Walkthrough Securities Gateways. So, if you
													are interested in these kind of products just call us
													we are here for you.
												</p>
											</div>
										</div>
									...
									<div className="u-container-layout u-container-layout-1">
										<div className="u-container-style u-expanded-width-xs u-group u-shape-rectangle u-group-1">
											<div className="u-container-layout u-container-layout-2">
												...
												<p className="u-align-justify u-text u-text-2">
													{" "}
													We are offering Network Solution include CoreSwitches
													| Wifi-Routers | Cabling And Networking | UPS Solution
													| Data Center Modeling | Solar Power Solution | WAN
													Optimization Solution. So, if you are interested in
													these kind of products just call us we are here for
													you.
												</p>
											</div>
										</div>
			...
			>
				<div className="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-sm u-valign-middle-xs u-sheet-1">
					...
					<div className="u-align-left u-image u-left-0 u-image-1">
						<Image data-image-width="1600" data-image-height="1000" src={xsx} />
					</div>
